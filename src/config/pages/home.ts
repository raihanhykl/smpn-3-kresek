...
export const homePageConfig: HomePageConfig = {
  ...
  gallery: {
    ...
    items: [
      { id: 'g1', caption: 'Upacara Bendera Hari Senin', emoji: '🚩', gradientFrom: '#1565C0', gradientTo: '#1E88E5', span: 'wide' },
      { id: 'g2', caption: 'Praktikum Laboratorium IPA', emoji: '🔬', gradientFrom: '#D1FAE5', gradientTo: '#6EE7B7' },
      { id: 'g3', caption: 'Pentas Seni Budaya', emoji: '🎭', gradientFrom: '#F3E8FF', gradientTo: '#C4B5FD' },
      { id: 'g4', caption: 'Kegiatan Pramuka', emoji: '⛺', gradientFrom: '#FEF9C3', gradientTo: '#FDE68A', span: 'wide' },
      { id: 'g5', caption: 'Sudut Baca Perpustakaan', emoji: '📚', gradientFrom: '#FEE2E2', gradientTo: '#FCA5A5' },
      { id: 'g6', caption: 'Kelas Teknologi Informasi', emoji: '💻', gradientFrom: '#DBEAFE', gradientTo: '#93C5FD' },
      { id: 'g7', caption: 'Pelepasan Siswa Kelas 9', emoji: '🎓', gradientFrom: '#FFF7ED', gradientTo: '#FED7AA' },
      { id: 'g8', caption: 'Meraih Prestasi di Olimpiade', emoji: '🏆', gradientFrom: '#ECFDF5', gradientTo: '#6EE7B7' },
    ],
