...
export const homePageConfig: HomePageConfig = {
  hero: {
    ...
    subtitle: 'Membentuk Generasi Cerdas, Berkarakter, dan Berprestasi di Kabupaten Tangerang',
    description:
  ...
  stats: {
    meta: {
      ...
      subtitle: 'Pencapaian nyata yang terus kami banggakan dan tingkatkan setiap tahunnya',
    },
    cards: [
  ...
  achievements: {
    ...
    items: [
      // TODO: replace with real achievements
      {
        ...
        recipient: 'Ananda Putri Ramadhani',
      ...
      },
      {
        id: 'a2',
        year: 2024,
        title: 'Juara 1 Lomba Futsal SMP Banten',
        recipient: 'Tim Futsal SMPN 3 Kresek',
      ...
      },
      {
        id: 'a4',
        year: 2023,
        title: 'Juara 2 Lomba Baca Puisi Banten',
        recipient: 'Siti Nur Aisyah',
      ...
      },
      {
        id: 'a5',
        year: 2023,
        title: 'Juara 1 Paduan Suara Tingkat SMP',
