...
export const profilPageConfig: ProfilePageConfig = {
  pageHeader: {
    breadcrumb: [{ label: 'Beranda', href: '/' }, { label: 'Profil Sekolah' }],
  ...
  sejarah: {
    ...
    timeline: [
      {
        id: 't1',
        marker: 'Tahun Pendirian',
        text: 'SMPN 3 Kresek resmi berdiri dan mulai menerima siswa pertamanya dari wilayah Kecamatan Kresek dan sekitarnya.',
      },
      {
        id: 't2',
        marker: 'Pengembangan Fasilitas',
        text: 'Pembangunan gedung baru, laboratorium IPA, laboratorium komputer, dan perpustakaan untuk meningkatkan kualitas pembelajaran.',
      },
      {
        id: 't3',
        marker: 'Pencapaian Akreditasi',
        text: 'Meraih status akreditasi dari Badan Akreditasi Nasional Sekolah/Madrasah (BAN-S/M) sebagai pengakuan kualitas layanan pendidikan.',
      },
      {
        id: 't4',
        marker: 'Era Digital & Kurikulum Merdeka',
        text: 'Transformasi digital dan implementasi Kurikulum Merdeka untuk menghadirkan pendidikan yang adaptif, inovatif, dan berpusat pada siswa.',
      },
    ],
  },
  visiMisi: {
    ...
    visi: {
      ...
      label: 'VISI',
      statement:
        '"Berahlak Mulia, Berprestasi, Kreatif, Bertanggungjawab, dan Berwawasan Lingkungan"',
    },
    misi: {
      icon: '📋',
      label: 'MISI',
      items: [
        ...
        'Menanamkan cinta tanah air, bangsa, dan negara.',
        'Mengembangkan potensi yang dimiliki siswa baik akademik maupun akademik',
        '⁠Menumbuh kembangkan rasa percaya diri',
        'Menciptakan lingkungan belajar yang aman dan nyaman',
        'Menanamkan budaya cinta kebersihan',
      ],
    },
  },
  tujuan: {
    ...
    cards: [
      {
        id: 'o1',
        number: '01',
        title: 'Prestasi Akademik Optimal',
        description:
          'Menghasilkan lulusan yang mencapai standar kompetensi nasional dengan nilai ujian yang memuaskan.',
      },
      {
        id: 'o2',
        number: '02',
        ...
        description:
          'Membentuk siswa yang memiliki akhlak mulia, disiplin, jujur, dan bertanggung jawab dalam kehidupan.',
      },
      {
        id: 'o3',
        number: '03',
        title: 'Kecakapan Abad 21',
        description:
          'Membekali siswa dengan kemampuan berpikir kritis, kreatif, komunikasi, dan kolaborasi yang solid.',
      },
      {
        id: 'o4',
        number: '04',
        ...
        description:
          'Menguasai teknologi informasi secara bijak dan produktif untuk mendukung proses belajar dan berkarya.',
      },
      {
        id: 'o5',
        number: '05',
        ...
        description:
          'Menumbuhkan semangat belajar sepanjang hayat dan kemampuan mengatur diri sendiri secara mandiri.',
      },
      {
        id: 'o6',
        number: '06',
        ...
        description:
          'Menanamkan cinta tanah air, semangat kebangsaan, dan kesadaran sebagai warga negara yang baik.',
      },
    ],
  },
  identitas: {
  ...
  guru: {
    ...
    teachers: [
      ...
      },
      {
        ...
        badge: 'S.Pd.',
        category: 'pimpinan',
        photo: { kind: 'gradient', from: '#FEF9C3', to: '#FDE68A', emoji: '👨‍💼' },
      },
      {
        id: 'g1',
        ...
        badge: 'S.Pd.',
        category: 'guru',
        photo: { kind: 'gradient', from: '#F3E8FF', to: '#C4B5FD', emoji: '👩‍🏫' },
      },
      {
        id: 'g2',
        ...
        badge: 'M.Pd.',
        category: 'guru',
        photo: { kind: 'gradient', from: '#FEE2E2', to: '#FCA5A5', emoji: '👨‍🏫' },
      },
      {
        id: 'g3',
        ...
        badge: 'S.Pd.',
        category: 'guru',
        photo: { kind: 'gradient', from: '#ECFDF5', to: '#6EE7B7', emoji: '👩‍🏫' },
      },
      {
        id: 'g4',
        name: 'Drs. Suryadi',
        ...
        badge: 'S.Pd.',
        category: 'guru',
        photo: { kind: 'gradient', from: '#EFF6FF', to: '#93C5FD', emoji: '👨‍🏫' },
      },
      {
        id: 'g5',
        ...
        badge: 'S.Pd.',
        category: 'guru',
        photo: { kind: 'gradient', from: '#FFF7ED', to: '#FED7AA', emoji: '👩‍🏫' },
      },
      {
        id: 'g6',
        name: 'Usman Hakim, S.Pd.',
        position: 'Guru PJOK',
        badge: 'S.Pd.',
        category: 'guru',
        photo: { kind: 'gradient', from: '#F0FDF4', to: '#86EFAC', emoji: '👨‍🏫' },
      },
      {
        id: 'g7',
        name: 'Lilis Suryani, S.Pd.I.',
        position: 'Guru Pendidikan Agama',
        badge: 'S.Pd.I.',
        category: 'guru',
        photo: { kind: 'gradient', from: '#FDF4FF', to: '#E879F9', emoji: '👩‍🏫' },
      },
      {
        id: 't1',
        name: 'Marlina, S.E.',
        ...
        badge: 'S.E.',
        category: 'tu',
        photo: { kind: 'gradient', from: '#F8FAFC', to: '#CBD5E1', emoji: '👩‍💻' },
      },
      {
        id: 't2',
        name: 'Irfan Maulana',
        ...
        badge: 'D3',
        category: 'tu',
        photo: { kind: 'gradient', from: '#F0FDF4', to: '#BBF7D0', emoji: '👨‍💻' },
      },
    ],
  },
  prestasi: {
    ...
    items: [
      ...
      },
      {
        id: 'fa2',
        year: 2024,
        title: 'Juara 1 Futsal SMP Se-Banten',
        recipient: 'Tim Futsal',
        organizer: 'KONI Banten',
        level: 'provinsi',
        photo: { kind: 'gradient', from: '#E0F2FE', to: '#FFFFFF', emoji: '🥇' },
      },
      {
        id: 'fa3',
        year: 2024,
        title: 'Juara 1 Karya Ilmiah Remaja',
        recipient: 'Tim KIR',
        organizer: 'Dinas Pendidikan Tangerang',
        level: 'kabupaten',
        photo: { kind: 'gradient', from: '#E0F2FE', to: '#FFFFFF', emoji: '🎖️' },
      },
      {
        id: 'fa4',
        year: 2023,
        title: 'Juara 2 Baca Puisi Banten',
        recipient: 'Siti Nur A.',
        organizer: 'Dinas Kebudayaan Banten',
        level: 'provinsi',
        photo: { kind: 'gradient', from: '#E0F2FE', to: '#FFFFFF', emoji: '📖' },
      },
      {
        ...
        recipient: 'Paduan Suara SMPN 3 Kresek',
        organizer: 'Pemkab Tangerang',
        level: 'kabupaten',
        photo: { kind: 'gradient', from: '#E0F2FE', to: '#FFFFFF', emoji: '🎤' },
      },
      {
        id: 'fa6',
        year: 2023,
        title: 'Juara 2 Bulu Tangkis Putri',
        recipient: 'Anisa Maharani',
        organizer: 'KONI Tangerang',
        level: 'kabupaten',
        photo: { kind: 'gradient', from: '#E0F2FE', to: '#FFFFFF', emoji: '🏸' },
      },
    ],
